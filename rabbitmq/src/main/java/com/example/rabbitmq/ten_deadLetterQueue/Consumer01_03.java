 ...
 * 版权：(C) 版权所有 2000-2021
 * <简述> 死信
 * <详细描述> 消息被拒，进入死信，生产者用Producer01_02
 *
 * @author qianxiaoning
 * @version V1.0
 * @see
...
//        arguments.put("x-max-length", 6);
        ...
        DeliverCallback deliverCallback = (consumerTag, message) -> {
            ...
            if ("info5".equals(msg)) {
                // 拒绝，且不塞回队列
                channel.basicReject(message.getEnvelope().getDeliveryTag(), false);// 不放回
                System.out.println(message + "被拒");
            } else {
